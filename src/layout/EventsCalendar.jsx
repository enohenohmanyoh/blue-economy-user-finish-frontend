...
const EventsCalendar = () => {
  ...
  const fetchEvents = async () => {
    try {
      ...
      // Normalize API data -> assume your backend returns: id, title, description, location, startDate, endDate, allDay
      const formattedEvents = res.data.map((event) => ({
        id: event.id,
        title: event.title,
        date: new Date(event.startDate),
        location: event.location,
        type: event.allDay ? "all-day" : "classroom", // default type mapping
